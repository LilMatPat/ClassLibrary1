...
namespace TiltWebsite.Models
{
    public class MustBeLoggedInAttribute : AuthorizeAttribute
    {
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
           ...
           {                //Call base class to allow user into the action metho                base.OnAuthorization(filterContext);
           }
            else
            {
             ...
             System.Web.Routing.RouteValueDictionary dict = new System.Web.Routing.RouteValueDictionary();              dict.Add("Controller","Home");
